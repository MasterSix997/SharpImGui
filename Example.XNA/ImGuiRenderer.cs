...
namespace Example.XNA
{
    ...
    public class ImGuiRenderer
    {
        ...
        // Textures
        private Dictionary<ulong, Texture2D> _loadedTextures;

        private int _textureId;
        private ulong? _fontTextureId;
        ...
        public ImGuiRenderer(Game game)
        {
            ...
            _loadedTextures = new Dictionary<ulong, Texture2D>();
        ...
        /// </summary>
        public virtual ulong BindTexture(Texture2D texture)
        {
            var id = (ulong)_textureId++;
        ...
        private bool TryMapKeys(Keys key, out ImGuiKey imguikey)
        {
            ...
            imguikey = key switch
            {
                ...
                Keys.LeftShift => ImGuiKey.ImGuiModShift,
                Keys.LeftControl => ImGuiKey.ImGuiModCtrl,
                Keys.LeftAlt => ImGuiKey.ImGuiModAlt,
