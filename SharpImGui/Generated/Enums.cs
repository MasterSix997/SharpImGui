...
namespace SharpImGui
{
	...
	/// <summary>
	/// Hinting greatly impacts visuals (and glyph sizes).<br/>
	/// - By default, hinting is enabled and the font's native hinter is preferred over the auto-hinter.<br/>
	/// - When disabled, FreeType generates blurrier glyphs, more or less matches the stb_truetype.h<br/>
	/// - The Default hinting mode usually looks good, but may distort glyphs in an unusual way.<br/>
	/// - The Light hinting mode generates fuzzier glyphs but better matches Microsoft's rasterizer.<br/>
	/// You can set those flags globaly in ImFontAtlas::FontBuilderFlags<br/>
	/// You can set those flags on a per font basis in ImFontConfig::FontBuilderFlags<br/>
	/// </summary>
	[Flags]
