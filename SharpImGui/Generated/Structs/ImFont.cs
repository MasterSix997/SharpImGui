...
namespace SharpImGui
{
	...
	public partial struct ImFont
	{
		...
		///     // Conceptually ConfigData[] is the list of font sources merged to create this font.<br/>
		/// 4-8   // out // What we has been loaded into<br/>
		/// </summary>
		public unsafe ImFontAtlas* ContainerAtlas;
		/// <summary>
		/// 4-8   // in  // Pointer within ContainerAtlas->ConfigData to ConfigDataCount instances<br/>
		/// </summary>
