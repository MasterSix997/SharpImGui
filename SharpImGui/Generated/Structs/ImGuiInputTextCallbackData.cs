...
namespace SharpImGui
{
	...
	public unsafe partial struct ImGuiInputTextCallbackDataPtr
	{
		...
		{
			return ImGuiNative.ImGuiInputTextCallbackDataHasSelection(NativePtr);
		}
		...
		public void InsertChars(int pos, ReadOnlySpan<char> text, ReadOnlySpan<char> textEnd)
		{
			...
			ImGuiNative.ImGuiInputTextCallbackDataInsertChars(NativePtr, pos, native_text, native_textEnd);
